...
def handle_message(event):
    ...
    if genre == "交通費":
        ...
        wks.update_cell(row + 2, col + 2, sum([int(i)
                                               for i in cell_money.splitlines()]))
        ...
        wks.update_cell(row + 3, col + 2, sum([int(i)
                                               for i in cell_money.splitlines()]))
        ...
        wks.update_cell(row + 4, col + 2, sum([int(i)
                                               for i in cell_money.splitlines()]))
        ...
        wks.update_cell(row + 5, col + 2, sum([int(i)
                                               for i in cell_money.splitlines()]))
        ...
        wks.update_cell(row + 6, col + 2, sum([int(i)
                                               for i in cell_money.splitlines()]))
        ...
        wks.update_cell(row + 7, col + 2, sum([int(i)
                                               for i in cell_money.splitlines()]))
